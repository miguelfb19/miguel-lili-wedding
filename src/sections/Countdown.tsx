  ...
  return (
    <div className="bg-nyanza-4 flex flex-col gap-4 justify-center items-center py-32">
      <motion.h2
        id="coutdown-date"
        {...translateLeftAnimation}
        className="font-great-vibes text-7xl text-olive-4"
      >
        Separa la fecha
      </motion.h2>
      <motion.span
        {...translateRightAnimation}
        id="date"
        className="font-montserrat font-thin text-3xl text-olive-3"
      >
      ...
      <motion.div {...translateRightAnimation}>
        <Button text="Agendar en google" as="a" href={googleCalendarUrl} targetBlank/>
      </motion.div>
    </div>
  );
};
